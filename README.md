...
The script **data_prep.py** retrieves the ACS variables using the Census API, prepares the datasets, and performs the SVD and determines the top feature contributions in the calculated components. It requires a registered API key. 
...
The script **pipelines.py** is the main driver of a SageMaker Pipelines machine learning operations (MLOps) environment and requires an AWS account.
